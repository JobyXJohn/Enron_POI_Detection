...
plot_features(data,data_dict,features_list,[3,5],[3,5,10])
...
### %%%%%%%%%% FOR SVM ############
ch2 = feature_selection.SelectKBest(feature_selection.chi2,k=7) # keep 7 for 
##                                                                  best svm
...
## Rescale the features again since new feature list is extracted:
Scaled_data = min_max_scaler.fit_transform(data)
...
precision,recall,thresholds = precisioin_recall_curve(labels_test,labels_pred)
